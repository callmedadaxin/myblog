	...
	exports.default = {
	  ...
	  methods: {
	    getTagList: function getTagList() {
	      ...
	      (0, _api.get)('tag').then(function (r) {
	        _this.tagList = r.data;
	      }).catch(function (r) {
	    ...
	    getTypeList: function getTypeList() {
	      ...
	      (0, _api.get)('type').then(function (r) {
	        _this2.typeList = r.data;
	      }).catch(function (r) {
	        _this2.$toast(r.message);
	      });
	    },
	    handleClose: function handleClose(tag, type) {
	      var _this3 = this;
	
	      var list = type === 'tag' ? this.tagList : this.typeList;
	
	      (0, _api.post)(type + '/delete', { id: tag._id }).then(function (r) {
	        _this3.$toast('删除成功！');
	        list.splice(list.indexOf(tag), 1);
	      }).catch(function (r) {
	        _this3.$toast(r.message);
	      });
	    },
	    showInput: function showInput(type) {
	      ...
	      if (type === 'tag') {
	        ...
	        this.$nextTick(function (_) {
	          _this4.$refs.saveTypeInput.$refs.input.focus();
	        });
	      }
	    },
	    handleInputConfirm: function handleInputConfirm() {
	      ...
	      (0, _api.post)('tag/add', { tag: inputValue }, true).then(function (r) {
	        _this5.$toast('添加成功！');
	        _this5.tagList.push(r.data);
	      }).catch(function (r) {
	        _this5.$toast(r.message);
	      });
	    },
	    handleTypeInputConfirm: function handleTypeInputConfirm() {
	      var _this6 = this;
	      ...
	      (0, _api.post)('type/add', { type: inputValue }, true).then(function (r) {
	        _this6.$toast('添加成功！');
	        _this6.typeList.push(r.data);
	      }).catch(function (r) {
	        _this6.$toast(r.message);
	      });
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.tags[data-v-0ed501f6] {\n  margin: 0 5px;\n}\n.input-new-tag[data-v-0ed501f6] {\n  max-width: 100px;\n}\n.content-card[data-v-0ed501f6] {\n  margin-bottom: 40px;\n}\n", "", {"version":3,"sources":["/./src/views/tags/src/views/tags/index.vue"],"names":[],"mappings":";AAkKA;EACE,cAAc;CACf;AAED;EACE,iBAAiB;CAClB;AAED;EACE,oBAAoB;CACrB","file":"index.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.tags{\n  margin: 0 5px;\n}\n\n.input-new-tag{\n  max-width: 100px;\n}\n\n.content-card{\n  margin-bottom: 40px;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/.css-loader@0.25.0/index.js?sourceMap!../../../node_modules/.vue-loader@9.9.5/lib/style-rewriter.js?id=data-v-0ed501f6&scoped=true!../../../node_modules/.sass-loader@4.1.1/index.js?sourceMap!../../../node_modules/.vue-loader@9.9.5/lib/selector.js?type=styles&index=0!./index.vue", function() {
				var newContent = require("!!../../../node_modules/.css-loader@0.25.0/index.js?sourceMap!../../../node_modules/.vue-loader@9.9.5/lib/style-rewriter.js?id=data-v-0ed501f6&scoped=true!../../../node_modules/.sass-loader@4.1.1/index.js?sourceMap!../../../node_modules/.vue-loader@9.9.5/lib/selector.js?type=styles&index=0!./index.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/wangxiaoxin/Desktop/node/blog/frontend/admin/src/views/tags/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-0ed501f6"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-0ed501f6", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-0ed501f6", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v("标签管理")])]), _vm._v(" "), _vm._l((_vm.tagList), function(tag) {
	    return _c('el-tag', {
	      key: tag,
	      staticClass: "tags",
	      attrs: {
	  ...
	  }, [_vm._v("+ New Tag")])], 2), _vm._v(" "), _c('el-card', {
	    staticClass: "content-card"
	  }, [_c('div', {
	    staticClass: "clearfix",
	    slot: "header"
	    ...
	    staticClass: "card-title"
	  }, [_vm._v("分类管理")])]), _vm._v(" "), _vm._l((_vm.typeList), function(type) {
	    return _c('el-tag', {
	      key: type,
	      staticClass: "tags",
	      attrs: {
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.inputTypeVisible),
	      expression: "inputTypeVisible"
	    }],
	    ref: "saveTypeInput",
	    staticClass: "input-new-tag",
	    attrs: {
	    ...
	    on: {
	      "blur": _vm.handleTypeInputConfirm
	    },
	    nativeOn: {
	      "keyup": function($event) {
	        if (!('button' in $event) && _vm._k($event.keyCode, "enter", 13)) { return null; }
	        _vm.handleTypeInputConfirm($event)
	      }
	    },
	    model: {
	      value: (_vm.inputValue),
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-0ed501f6", module.exports)
	  }
	}

/***/ }
]);
//# sourceMappingURL=1.808dc801c0aac40bb2f6.js.map